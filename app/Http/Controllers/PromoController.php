...
class PromoController extends Controller {
    ...
    public function index(){
        ...
        $promo = Toko::select('toko.id as id_toko', 'nama_toko', 'menu.id as id_menu', 'menu.nama_menu', 'menu.harga', 
                            'menu.gambar', 'promo.persentase', 'jenis_promo.nama_jenis_promo as jenis_promo')
